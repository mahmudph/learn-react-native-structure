...
import {
    StatusBar, FlatList, ScrollView, Platform, Alert, SafeAreaView, StyleSheet, AsyncStorage, Keyboard,
    TouchableOpacity, Text, TextInput, KeyboardAvoidingView, ImageBackground, Dimensions, Image, View
} from
    'react-native'
                ...
                <View style={styles.wrapper}>
                    ...
                    <View style={styles.content}>
                        <View style={styles.root}>
                            <TouchableOpacity style={styles.row} onPress={() => this.konfirmasi()}>
